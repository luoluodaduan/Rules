...
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|说明|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|儿童|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|酷奇MV|翻墙|广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|peizhi|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|说明|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|儿童|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|酷奇MV|翻墙|广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|peizhi|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|说明|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|儿童|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|酷奇MV|翻墙|广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|peizhi|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|说明|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|儿童|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|酷奇MV|翻墙|广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|peizhi|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/,\s*\{([^\{]*)"key"((?!("key"|\],)).)+(公告|说明|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|儿童|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|酷奇MV|翻墙|广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|peizhi|网盘|云盘)((?!("key"|\],)).)+([^\[]+)("parses"|"rules")/\],$8/g'
...
find fan -name '[0-9].json' | xargs perl -pi -e 's|(["=])https?:/([^"=]*)/raw\.([^/]+)/([^/]+)/([^/]+)/|$1https://gh-proxy.org/https://raw.githubusercontent.com/$4/$5/|g'
find fan -name '[0-9].json' | xargs perl -pi -e 's|(["=])https?:/([^"=]*)/github\.com/([^/]+)/([^/]+)/raw/|$1https://gh-proxy.org/https://raw.githubusercontent.com/$3/$4/|g'
find fan -name '[0-9].json' | xargs perl -pi -e 's|(["=])https?:/([^"=]+)\.jsdelivr\.net/gh/([^/]+)/([^/]+)@|$1https://gh-proxy.org/https://raw.githubusercontent.com/$3/$4/|g'

find fan -name '1.json' | xargs perl -pi -e 's|(["=])\./|$1https://gh-proxy.org/https://raw.githubusercontent.com/n3rddd/N3RD/master/JN/|g'
find fan -name '2.json' | xargs perl -pi -e 's|(["=])\./|$1https://gh-proxy.org/https://raw.githubusercontent.com/xyq254245/xyqonlinerule/main/|g'
find fan -name '3.json' | xargs perl -pi -e 's|(["=])\./|$1https://gh-proxy.org/https://raw.githubusercontent.com/yoursmile66/TVBox/main/|g'
find fan -name '4.json' | xargs perl -pi -e 's|(["=])\./|$1https://gh-proxy.org/https://raw.githubusercontent.com/ne7359/tvurl/main/|g'
find fan -name '5.json' | xargs perl -pi -e 's|(["=])\./|$1https://gh-proxy.org/https://raw.githubusercontent.com/ne7359/tvurl/main/xiaosa/|g'
find fan -name '6.json' | xargs perl -pi -e 's|(["=])\./|$1https://gh-proxy.org/https://raw.githubusercontent.com/wanganni/yinshiyuan/main/|g'
