...
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|短剧|少儿|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|音乐|短视频|酷奇MV|预告|翻墙|任何广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|短剧|少儿|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|音乐|短视频|酷奇MV|预告|翻墙|任何广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|短剧|少儿|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|音乐|短视频|酷奇MV|预告|翻墙|任何广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/\{([^\{]*)"key"((?!"key").)+(公告|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|短剧|少儿|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|音乐|短视频|酷奇MV|预告|翻墙|任何广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|网盘|云盘)((?!"key").)+\{([^\{]*)"key"/{$5"key"/g'
find dist -name '[0-9].json' | xargs perl -pi -e 's/,\s*\{([^\{]*)"key"((?!("key"|\],)).)+(公告|Market|FirstAid|csp_Push|LocalFile|YouTube|Youtube|bili|Bili|DJMV|哔哩|短剧|少儿|戏曲|墙外|小说|童趣|兔小贝|听书|广播|相声|评书|音乐|短视频|酷奇MV|预告|翻墙|任何广告|push_agent|Cloud-drive|alitoken|csp_Pan|AList|配置|网盘|云盘)((?!("key"|\],)).)+([^\[]+)("parses"|"rules")/\],$8/g'
